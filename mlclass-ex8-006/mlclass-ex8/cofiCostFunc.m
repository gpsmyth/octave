...
%    All error factors will be 0 for movies that a user has not rated.
% -------------------------------------------------------------
% keyboard;
movie_ratings = X * Theta';
moive_rating_err = movie_ratings - Y;
% error_factor = moive_rating_err' * R;
error_factor = moive_rating_err .* R;
% -------------------------------------------------------------
...
% - Add the regularization terms to their base values.
lambda_x = lambda * X;
...
% Done. No loops.
% =============================================================
% X_grad is the derivatives for the feature vector of the movies:
